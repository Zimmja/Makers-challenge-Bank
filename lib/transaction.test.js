...
describe(".getData", () => {
  ...
  test("Works on more complicated withdrawals", () => {
    const transactionObj = new Transaction(17.55, 20, false, testDate);
    const transactionData = transactionObj.getData();
    expect(transactionData.balance).toEqual("-2.45");
  });
});
